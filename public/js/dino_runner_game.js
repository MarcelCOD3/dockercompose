document.addEventListener("DOMContentLoaded", () => {
  ...
  const musicOriginal = new Audio("/public/audio/background-music.mp3");
  musicOriginal.loop = true;
  musicOriginal.volume = 0.4;
  const musicRemix = new Audio("/public/audio/background-music-remix.mp3");
  ...
  muteBtn.addEventListener('click', () => {
    ...
    muteBtn.src = isMuted ? '/public/img/icon-volume-off.png' : '/public/img/icon-volume-on.png';
  });
